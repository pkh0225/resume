...
# TMDesion Site 아래링크 9번에 제가 직접 만든 Open Source인 [Easy AutoLayout - UIView Extension](https://github.com/pkh0225/EasyConstraints) 소개됨
...
# 업무적 강점
 ...
 - 직책에 연연하지 않고 여러 동료 직원과의 업무 지향적 협업 태도
 - 다양한 서비스 개발 경험으로 하드웨에 제어 개발에서 부터 윈도우 어플리케이션 개발등 복잡하고 거대한 서비스의 설계, 개발, 운영까지 담당하는 총괄 경험
...
- 공통 모듈 개발
  ...
  4. LinkManager - Url 딥링크 처리 및 관리하는 기능
...
### Qiqip `andriod(Java)`
<img alt="이미지" src="/images/Qiqip/Qiqip1.jpg" height="300"> <img alt="이미지" src="/images/Qiqip/Qiqip2.jpg" height="300"> <img alt="이미지" src="/images/Qiqip/Qiqip3.jpg" height="300"> <img alt="이미지" src="/images/Qiqip/Qiqip4.jpg" height="300"> <img alt="이미지" src="/images/Qiqip/Qiqip5.jpg" height="300">
- Call log 관리, 주소록 관리, 채팅 메신져, 검색서비스
- 전체 DB및 구조 설계, 주소록 관리, 디바이스 – 서버 데이타 Sync

### 삼성 ChatON `iOS(Object-C)`
<img alt="이미지" src="/images/ChatON/ChatON1.png" height="300"> <img alt="이미지" src="/images/ChatON/ChatON2.png" height="300">
- 채팅 메신져, 소셜네트워킹
- 카카오 스토리 같은 소셜네트워킹 부분 신규 기능 추가 및 유지보수

### 하루한장 `iOS(Object-C)`
<img alt="이미지" src="/images/day/day1.png" height="300"> 

- SK텔레콤에서 하는SNS서비스로 사진을 하루에 한장씩만 서로 공유하면서 의사소통을 할 수 있는 SNS앱서비스
- 이미지 편집기능(잘라내기, 회전하기, 축소, 확대)
- 이미지 필터(밝기, 대비, 흑백, 블랙엣지, 네가티브, 퀀타이즈, 세피아, 아쿠아, 노이즈, 스미어크로스)
- 이미지 슬라이더 기능

### 신세계기프트 `iOS(Object-C)`
<img alt="이미지" src="/images/sg/sg1.png" height="300"> <img alt="이미지" src="/images/sg/sg2.png" height="300"> <img alt="이미지" src="/images/sg/sg3.png" height="300"> <img alt="이미지" src="/images/sg/sg4.png" height="300">
- 신세계모바일 상품권을 구입,충전,선물할 수 있고 신세계모바일 상품권을 등록하여 편리하게 사용할 수 있고 관리할 수 있는 앱
- 프로젝트 전체 설계 및 개발

### 잡앤알 개인용/기업용 `iOS(Object-C)`
<img alt="이미지" src="/images/hnr/hnr1.jpg" height="280"> <img alt="이미지" src="/images/hnr/hnr2.jpg" height="280"> <img alt="이미지" src="/images/hnr/hnr3.jpg" height="280"> <img alt="이미지" src="/images/hnr/hnr4.jpg" height="280"> <img alt="이미지" src="/images/hnr/hnr5.jpg" height="280">
- 이력서를 등록하여 기업에 등록된 프로젝트를 검색하고 지원할 수 있으며 내가 지원한 프로젝트를 한눈에 볼수 있고 기업담당자와 채팅도 할수 있어 입사지원을 도와주는 앱
- 프로젝트 전체 설계 및 개발

### mHidoc `iOS(Object-C)`
<img alt="이미지" src="/images/mHidoc/mHidoc1.jpg" height="300"> <img alt="이미지" src="/images/mHidoc/mHidoc2.jpg" height="300"> <img alt="이미지" src="/images/mHidoc/mHidoc3.jpg" height="300"> <img alt="이미지" src="/images/mHidoc/mHidoc4.jpg" height="300">
- 대웅제약에서 제공하는 의사와 환자를 연결 해주는 앱
- 원하는 의사 찾기, 예약 하기, 의사와 채팅, 병원 정보, 건강관련 뉴스제공 등
- 프로젝트 전체 설계 및 개발

### 이마트 쇼핑몰HD(ipad) `iOS(Object-C)`
<img alt="이미지" src="/images/eMartHD/eMartHD1.png" height="300"> <img alt="이미지" src="/images/eMartHD/eMartHD2.png" height="300"> <img alt="이미지" src="/images/eMartHD/eMartHD3.png" height="300">
- PC용 이마트 쇼핑몰을 iPad에서도 똑같이 사용할 수 있도록 해주는쇼핑앱
- 프로젝트 전체 설계 및 개발

### 누가와 `iOS(Object-C)`
<img alt="이미지" src="/images/nugawa/nugawa1.jpg" height="300"> <img alt="이미지" src="/images/nugawa/nugawa2.jpg" height="300"> <img alt="이미지" src="/images/nugawa/nugawa3.jpg" height="300"> <img alt="이미지" src="/images/nugawa/nugawa4.jpg" height="300">
- 온/오프라인 모임과 행사를 좀 더 쉽게 진행 할 수 있도록 해주는 앱(지금의 밴드와 비슷한앱)
- 프로젝트 전체 설계 및 개발

### Polltalk `iOS(Object-C)`
<img alt="이미지" src="/images/Polltalk/Polltalk1.png" height="300"> <img alt="이미지" src="/images/Polltalk/Polltalk2.png" height="300"> <img alt="이미지" src="/images/Polltalk/Polltalk3.png" height="300"> <img alt="이미지" src="/images/Polltalk/Polltalk4.png" height="300">
- SNS를 통해 투표를 만들고 참여 할 수 있는 앱
- 실시간 투표 결과와 집계표 그리고 댓글을 이용한 사용자 의견을 주고 받을 수 있는 SNS앱
- 프로젝트 전체 설계 및 개발

### POPCamera `iOS(Object-C)`
<img alt="이미지" src="/images/POPCamera/POPCamera1.png" height="300"> 

- 스마트폰으로 촬영한 사진이나 동영상 파일을 손쉽게 저장하고 원하는 홈페이지나 채널에 손쉽게 연동할 수 있는 앱
- 프로젝트 전체 설계 및 개발

### 동나미 `iOS(Object-C)`
<img alt="이미지" src="/images/dong/dong1.png" height="300"> 
...
<img alt="이미지" src="/images/brs/brs.png" height="300"> 

- 수명이 다한Battery(자동차나 공장에서 쓰이는 대용량Battery) 를 다시 복원시켜주는 시스템
- 장비에 표시는 LCD의 UI작업을 안드로이드 OS기반으로 앱형태로 개발

### ARGO `Windos(Enterprise Architect UML)`
<img alt="이미지" src="/images/argo/argo1.png" height="300"> <img alt="이미지" src="/images/argo/argo2.png" height="300"> 

- 아르고 시스템의 전체 장비들을 제어하여 국내에서 관측가능한 위성을 레이져를 쏘아 위성의 반사판에 맞고 돌아오는 시간을 계산하여 위성의 위치를 추적할 는 시스템 개발
- 위성의 위치를 NASA사이트에 정보를 공유하여 전문연구에 필요한 자료를 수집을 목적으로 하는 시스템 개발
- 전세계 최초 수동적인 시스템을 전자동화하여 데이터의 정확성과 효율성을 높이는 프로그램


### 미어켓(극동기상연구소) `Window(Delphi, MSSQL)`
<img alt="이미지" src="/images/meerkat/meerkat1.jpg" height="300"> 

- 미어켓프로그램에서 제어해야할 위성장비들의 드라이버 개발 및 추가기능 개발
- 위성장비 RS232 드라이버개발 및 추가기능개발


### KT CMS(Customer Manager System) `Window(Delphi, MSSQL)`
<img alt="이미지" src="/images/cms/cms1.jpg" height="300"> 

- 위성 방송 장비들의 통합적이고 효율적으로 관리 하기 위한 프로그램
- 프로젝트 전체 설계 및 개발

### LG MusicOn & Mobile Manager2 `Window(Delphi)`
<img alt="이미지" src="/images/MusicOn2/MusicOn21.jpg" height="300"> <img alt="이미지" src="/images/MusicOn2/MusicOn22.jpg" height="300">
...
### LG MusicOn & Mobile Manager1 `Window(Delphi)`
<img alt="이미지" src="/images/MusicOn/MusicOn1.jpg" height="300"> <img alt="이미지" src="/images/MusicOn/MusicOn2.jpg" height="300">
...
<img alt="이미지" src="/images/tbs/tbs.png" height="300">
...
<img alt="이미지" src="/images/tu/tu1.png" height="300"> <img alt="이미지" src="/images/tu/tu2.png" height="150">
...
<img alt="이미지" src="/images/hm/hm1.png" height="300"> <img alt="이미지" src="/images/hm/hm2.png" height="300">
...
<img alt="이미지" src="/images/dmbs/dmbs.jpg" height="300">
